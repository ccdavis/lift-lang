...
impl JITCompiler {
    ...
    pub fn new() -> Result<Self, Box<dyn Error>> {
        ...
        // Retain/Release symbols for reference counting
        builder.symbol("lift_str_retain", runtime::lift_str_retain as *const u8);
        builder.symbol("lift_str_release", runtime::lift_str_release as *const u8);
